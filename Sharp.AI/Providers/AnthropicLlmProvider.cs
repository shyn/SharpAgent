...
public sealed class AnthropicLlmProvider : ILlmProvider
{
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        var nonSystemMessages = new List<AnthropicMessage>(normalizedMessages.Count);
        foreach (var message in normalizedMessages)
        {
            if (message.Role != LlmMessageRole.System)
                nonSystemMessages.Add(ToAnthropicMessage(message));
        }
    ...
    private static AnthropicMessage ToAnthropicMessage(LlmMessage message)
    {
        ...
        {
            ToolResultContentBlock? toolResult = null;
