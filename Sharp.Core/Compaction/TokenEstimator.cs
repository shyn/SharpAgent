...
public static class TokenEstimator
{
    ...
    public static int EstimateTokens(string? text)
    {
        ...
        // Optimization: Use integer arithmetic equivalent to Math.Ceiling(length / 4.0)
    ...
    {
        // Optimization: Calculate cumulative tokens on the fly to avoid O(N) array allocation
        var cumulative = 0;
