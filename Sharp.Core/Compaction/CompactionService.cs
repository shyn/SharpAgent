...
public sealed class CompactionService
{
        ...
        CancellationToken ct = default)
    {
        ...
        else
        {
            ...
            keptEntries = new List<SessionEntryEnvelope>(keptCount);
        ...
        CancellationToken ct = default)
    {
        ...
        if (firstKeptEntryId != null)
        {
            ...
            {
                remainingEntries = list.GetRange(compactedEntryIds.Count, entries.Count - compactedEntryIds.Count);
            }
            else
            {
                var remainingCount = entries.Count - compactedEntryIds.Count;
                remainingEntries = new List<SessionEntryEnvelope>(remainingCount);
