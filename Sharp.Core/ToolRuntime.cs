...
public sealed class ToolRuntime
{
        ...
        ExtensionRuntime? extensionRuntime = null)
    {
        ...
        // Performance optimization: Cache the tool definitions list during instantiation
        // to prevent redundant LINQ `.Select().ToList()` allocations on every AgentLoop turn.
