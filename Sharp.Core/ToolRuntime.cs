...
public sealed class ToolRuntime
{
        ...
        ExtensionRuntime? extensionRuntime = null)
    {
        ...
        // Bolt Optimization: Cache the tool definitions list at construction time
        // rather than re-evaluating .Select().ToList() every time ToToolDefinitions() is called.
        // This eliminates a recurring O(N) array allocation on the hot path (AgentLoop).
        // It relies on the fact that ToolRuntime is immutable after construction.
