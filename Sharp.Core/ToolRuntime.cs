...
public sealed class ToolRuntime
{
        ...
        ExtensionRuntime? extensionRuntime = null)
    {
        ...
        // Optimization: Cache ToolDefinitions at construction to avoid repeatedly
        // allocating new lists (O(N) operation) on the hot path (AgentLoop.cs),
        // which reduces GC pressure during sustained agent conversations.
