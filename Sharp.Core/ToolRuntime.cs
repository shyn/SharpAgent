...
public sealed class ToolRuntime
{
    ...
    /// <summary>
    /// Gets the registered tool definitions.
    /// Performance note: This method returns a cached list to avoid per-turn allocations
    /// caused by creating a new ToolDefinition list via LINQ.
    /// </summary>
